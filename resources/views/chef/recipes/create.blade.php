<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20" x-data="{ 
        ...
        <div class="bg-white border-4 border-nusarasa-dark rounded-[3rem] p-8 md:p-16 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]" data-aos="fade-up">
            <form action="{{ route('chef.recipes.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <div class="space-y-2">
                            ...
                            <x-text-input id="calories" name="nutrition[calories]" type="number" step="0.1" class="block w-full text-center" placeholder="0" />
                        </div>
                        <div class="space-y-2">
                            <x-input-label for="protein" :value="__('Protein (g)')" class="text-xs font-black uppercase tracking-widest opacity-60 text-center" />
                            <x-text-input id="protein" name="nutrition[protein]" type="number" step="0.1" class="block w-full text-center" placeholder="0" />
                        </div>
                        <div class="space-y-2">
                            <x-input-label for="carbs" :value="__('Karbo (g)')" class="text-xs font-black uppercase tracking-widest opacity-60 text-center" />
                            <x-text-input id="carbs" name="nutrition[carbs]" type="number" step="0.1" class="block w-full text-center" placeholder="0" />
                        </div>
                        <div class="space-y-2">
                            <x-input-label for="fat" :value="__('Lemak (g)')" class="text-xs font-black uppercase tracking-widest opacity-60 text-center" />
                            <x-text-input id="fat" name="nutrition[fat]" type="number" step="0.1" class="block w-full text-center" placeholder="0" />
                        </div>
                        <div class="space-y-2 col-span-2 md:col-span-1">
                            ...
                            <x-text-input id="fiber" name="nutrition[fiber]" type="number" step="0.1" class="block w-full text-center" placeholder="0" />
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="relative border-4 border-dashed border-nusarasa-dark/20 rounded-[2rem] overflow-hidden transition-all hover:border-nusarasa-dark/50"
                        ...
                        <!-- File Input (always on top, invisible) -->
