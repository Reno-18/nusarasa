    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div class="py-16 text-center" data-aos="zoom-in">
            <h1 class="text-6xl md:text-7xl font-black font-display uppercase tracking-tighter leading-none text-nusarasa-dark mb-4">
                Buat <span class="text-nusarasa-purple">Templat</span>
            </h1>
            ...
            <form action="{{ route('chef.meal-plan-templates.store') }}" method="POST" class="space-y-10">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <x-text-input id="name" name="name" type="text" class="block w-full" :value="old('name')" required placeholder="Contoh: Menu Sehat 7 Hari, Diet Keto Mingguan..." />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <x-text-input id="goal" name="goal" type="text" class="block w-full" :value="old('goal')" placeholder="Contoh: Diet, Bulking, Sehat..." />
                        </div>
                        <div class="space-y-2">
                            ...
                            <x-text-input id="description" name="description" type="text" class="block w-full" :value="old('description')" placeholder="Gambaran singkat tentang templat ini" />
                        </div>
                    </div>
                </div>
